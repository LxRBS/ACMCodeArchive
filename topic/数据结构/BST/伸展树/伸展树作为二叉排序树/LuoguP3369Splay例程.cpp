...
int main(){
    ...
    while(n--){//所有指令保证有解
        switch(getInt()){
            case 1:insert(Root,getInt());break;
            case 2:remove(Root,getInt());break;
            case 3:printf("%d\n",rank(Root,getInt()));break;
            case 4:printf("%d\n",Node[kth(Root,getInt())].key);break;
            case 5:printf("%d\n",Node[pred(Root,getInt())].key);break;
            case 6:printf("%d\n",Node[succ(Root,getInt())].key);break;
