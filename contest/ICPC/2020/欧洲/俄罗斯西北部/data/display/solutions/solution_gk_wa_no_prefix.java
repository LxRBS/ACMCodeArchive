// Forget to increment when first pixel is on
 ...
 */
public class solution_gk_wa_no_prefix {
    ...
    public static void main(String[] args) {
        ...
        out = System.out;
        new solution_gk_wa_no_prefix().run();
    }
    ...
    private void run() {
        ...
        final int chars = (s + max - 1) / max;
        out.println(new String(new char[chars]).replace('\0', answer));
    }
