...
public class LedLedPaths_md {
	...
	public static void main(String[] args) throws IOException {
		...
		String fileName = LedLedPaths_md.class.getSimpleName().replaceFirst("_.*", "").toLowerCase();
